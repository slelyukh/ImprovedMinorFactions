    ...
    public class MFMafiaCaravanExtortionIssueBehavior : CampaignBehaviorBase
    {
        ...
        public class MFMafiaCaravanExtortionIssue : IssueBase
        {
            ...
            public override TextObject IssueBriefByIssueGiver
            {
                get
                {
                    var text = new TextObject("{=!}The local notables were paying us a very modest fee to 'protect' their caravans. " +
            ...
            public override TextObject IssueQuestSolutionExplanationByIssueGiver
            {
                get
                {
                    var text = new TextObject("{=!}Raid some caravans pls");
                    return text;
                }
            }
            ...
            {
                get => new TextObject("{=!}I'll raid your caravans.");
            }
            ...
            {
                get => new TextObject("{=!}{MINOR_FACTION} Needs Caravans Extorted").SetTextVariable("MINOR_FACTION", IssueClan().Name);
            }
        ...
        public class MFMafiaExtortionQuest : QuestBase
        {
            ...
            public override TextObject Title
            {
                get => new TextObject("{=!}{MINOR_FACTION} Needs Caravans Extorted").SetTextVariable("MINOR_FACTION", QuestClan().Name);
            }
            ...
            private TextObject QuestStartedLogText
            {
                get
                {
                    TextObject text = new TextObject("{=!}{QUEST_GIVER.LINK} told you that {?QUEST_GIVER.GENDER}she{?}he{\\?} needs caravans extorted. " +
                        "{?QUEST_GIVER.GENDER}She{?}He{\\?} asked you to extort {NEEDED_CARAVAN_AMOUNT} caravans near {?QUEST_GIVER.GENDER}her{?}his{\\?} hideout " +
                        "then give {?QUEST_GIVER.GENDER}her{?}him{\\?} the profits. You will be allowed to keep a portion of the profits.");
            ...
            private TextObject QuestSuccessLog
            {
                get
                {
                    TextObject text = new TextObject("{=!}You have extorted the caravans for {QUEST_GIVER.LINK} as promised.");
                    text.SetCharacterProperties("QUEST_GIVER", base.QuestGiver.CharacterObject);
                    return text;
                }
            }
            ...
            private void AddDialogs(CampaignGameStarter starter)
            {
                ...
                //starter.AddPlayerLine("caravan_extortion", "caravan_talk", "common_encounter_ultimatum_answer", "{=!}I am here to collect your safe passage payments",
                //    new ConversationSentence.OnConditionDelegate(this.caravan_extortion_on_condition), null);
                //starter.AddDialogLine("caravan_extortion_attack", "common_encounter_ultimatum_answer", "close_window", "{=n99VA8KP}You'll never take us alive![if:convo_angry][ib:aggressive]", 
                //    null, new ConversationSentence.OnConsequenceDelegate(this.caravan_extortion_failure_on_consequence));
            }
            ...
            {
                GiveGoldAction.ApplyForPartyToCharacter(MobileParty.ConversationParty.Party, Hero.MainHero, 2000);
                ...
                this._targetCaravans.Remove(MobileParty.ConversationParty);
                base.RemoveTrackedObject(MobileParty.ConversationParty);
                this._extortedCaravans.Add(MobileParty.ConversationParty);
            ...
            private void ApplyQuestSuccessConsequences()
            {
                ...
                // TODO: set proper reward gold before this
            ...
            // TODO: adapt
            private const int PlayerRogueryBonusOnSuccess = 30;
